...
export const Route = createFileRoute("/adatkezeles")({
  head: () => ({ meta: [{ title: "Adatkezelési tájékoztató — Vidák Gábor" }, { name: "description", content: "Adatkezelési tájékoztató a GDPR szerint." }] }),
  component: Adat,
});
  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl space-y-4 px-4 py-16 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>Vidák Gábor — info@vidakgabor.hu</p>
